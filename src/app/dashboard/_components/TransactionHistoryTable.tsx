...
const TransactionHistoryTable = ({ onOpenModal }: ITable) => {
  ...
  return (
    <div className="w-full font-clash_display">
      <div className="mb-2 w-full p-4 md:p-5 rounded-lg flex justify-between items-center gap-4 bg-white md:flex-nowrap flex-wrap">
        <div className="flex justify-start items-center gap-7 min-w-max">
          <h2 className="font-semibold text-lg lg:text-xl text-neutral-900 min-w-max">
            Transaction History
          </h2>
      ...
      <div className="mb-2 w-full p-4 md:p-5 rounded-lg flex justify-between items-center gap-4 bg-white md:flex-nowrap flex-wrap">
          ...
          <button
            ...
            className={`${
              filter === "all"
                ...
                : "text-neutral-300"
            } px-4 py-2.5 rounded-lg ease transition-all duration-200 text-lg lg:text-xl`}
          >
            All
          </button>
          <button
        ...
        <div className="flex justify-start items-center gap-2">
          ...
          >
            <GoPlus />
            <p className="font-clash_display">Recycle now</p>
          </button>
        </div>
      </div>
        ...
        <table className="w-full min-w-max whitespace-nowrap overflow-hidden px-4 md:px-5 py-4 bg-white rounded-lg">
          ...
          <tbody>
            ...
            {currentItems.length < 1 && !isLoading ? (
              <tr className="w-full border-b border-neutrals100 font-clash_display_medium text-neutrals500">
                <td
